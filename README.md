...
AI Hub Baseline은 Llama 기반 모델로, AI Hub에서 제공하는 서술형 글쓰기 평가 데이터셋의 공식 베이스라인. 원래 1.0~5.0 (0.5 단위) 스케일을 1~9 정수 스케일로 변환하여 비교.
...
- **Adj Acc (+-1)**: Baseline이 77.03%로 가장 높으나, 이는 0.5 단위 스케일의 특성상 인접 점수 적중률이 높기 때문
