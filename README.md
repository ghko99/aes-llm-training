...
| Loss | QWK | MAE | RMSE | Exact Acc | Adj Acc (+-1) |
|------|-----|-----|------|-----------|-------------|
| AI Hub Baseline (Llama) | 0.7049 | 0.978 | 1.331 | 0.3261 | 0.7703 |
| CE | 0.7003 | 1.017 | 1.418 | 0.3479 | 0.7338 |
| NTL | 0.7334 | 0.932 | 1.363 | 0.4045 | 0.7533 |
| **WNTL** | **0.7406** | 0.958 | 1.380 | 0.3891 | 0.7477 |
| SAL | 0.6829 | 1.044 | 1.440 | 0.3345 | 0.7251 |
| NTL+SAL | 0.7347 | **0.929** | **1.342** | **0.4045** | **0.7553** |
| WNTL+SAL | 0.7247 | 0.979 | 1.399 | 0.3805 | 0.7391 |

- **QWK**: WNTL(0.7406)이 Baseline(0.7049) 대비 +0.036 향상
- **MAE / RMSE**: NTL+SAL이 가장 낮은 오차 (MAE 0.929, RMSE 1.342)
- **Adj Acc (+-1)**: Baseline이 77.03%로 가장 높음
